...
FlierData Scout
{
   ...
   minSpeed = -2;
	...
	visibleDriver = true;
	driverPose = 22;
	description = "SCOUT Light Attack Vehicle";
};
...
FlierData LAPC
{
   ...
   minSpeed = -1;
	...
	visibleDriver = true;
	driverPose = 23;
	description = "LPC Personel Carrier";
};
...
FlierData HAPC
{
   ...
   minSpeed = -1;
	...
	visibleDriver = true;
	driverPose = 23;
	description = "HPC Heavy Personel Carrier";
};
...
{
if ($Pilot::DebugMode)
  echo("BOTPILOT> Collision between vehicle=" @ %this @ " and player=" @ %object);
